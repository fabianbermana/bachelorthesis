...
2. Installing the wals Package

A. Change to the directory that contains the file setup.py and the subdirectory wals. If 
...
3. Using the wals Package

The wals package is on your Python path. To import it into a Python script or session, 
execute:
